...
<div class="header"> 
	...
	<form action="http://localhost:8080/CarMatch/LoginServlet" method="POST" id="login">
	...
	<% } 
        ...
        %>
	<form action="http://localhost:8080/CarMatch/LogoutServlet" method="POST" id="logout">
